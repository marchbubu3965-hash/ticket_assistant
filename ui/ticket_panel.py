...
class TicketPanel(QWidget):
    ...
    def _init_ui(self):
        ...
        # ===== 排程時間（單次） =====
        schedule_box = QGroupBox("排程訂票（單次）")
        schedule_layout = QHBoxLayout(schedule_box)

        self.schedule_checkbox = QCheckBox("啟用排程")
        ...
        self.schedule_date_edit.setDisplayFormat("yyyy-MM-dd")
        ...
        schedule_layout.addWidget(self.schedule_date_edit)
